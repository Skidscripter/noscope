...
local Lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Skidscripter/ss/main/ssss.lua", true))();
...
local ESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/Skidscripter/noscope/main/esp.lua"))();
local Aim = Section1:CreateToggle({
	Title = "Player ESP",
	Order = 1,
	Default = false,
